  ...
  return (
    <>
      ...
      <div className="mt-10 grid grid-cols-3 gap-4">
        <div className={"flex flex-col border border-primary rounded-lg p-5 gap-4"}>
          <img
          ...
          />
          <div className={"text-primary text-2xl font-bold"}>Top 10 Inference Models</div>
          <div className={"flex flex-row"}>
            <Badge variant={"default"} className={"bg-gray-300 text-muted-foreground font-bold"}>
              test
            </Badge>
          </div>
          <div className={"text-md"}>Offer guidance on self-care practices andactivities that promote mental health andemotional well-being.</div>
